...
const Style = styled.div`
  ...
  .whatswidget-conversation {
    ...
    box-shadow: rgba(0, 0, 0, 0.16) 0 5px 40px !important;
  ...
  .whatswidget-conversation-header {
    ...
    background-color: #64523c !important;
    padding: 10px !important;
    padding-left: 25px !important;
    box-shadow: 0 1px #f8e9d2 !important;
  ...
  .whatswidget-conversation-message-outer {
    ...
    border-radius: 5px !important;
    box-shadow: rgba(0, 0, 0, 0.342) 0 2.5px 10px !important;
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Bem-vinda(o) ao nosso site!
            </div>
            <div
              id="whatswidget-conversation-message"
              className="whatswidget-conversation-message"
            >
              Estou com dúvidas aqui no site, pode me ajudar?
            </div>
            <div className="whatswidget-conversation-cta">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://wa.me/5548991502600?text=Olá, estou com dúvidas aqui no site, pode me ajudar?"
          ...
          <div className="whatswidget-button-wrapper">
            <div className="whatswidget-button" id="whatswidget-button">
